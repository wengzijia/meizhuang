...
var _goodsDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/goodsDetail/goodsDetail.vue */ 255));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _goodsDetail_vue_vue_type_template_id_21ea9296___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=template&id=21ea9296& */ 256);
/* harmony import */ var _goodsDetail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=script&lang=js& */ 258);
...
/* harmony import */ var _goodsDetail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./goodsDetail.vue?vue&type=style&index=0&lang=scss& */ 261);
...
try {
  components = {
    uniPopup: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-popup/components/uni-popup/uni-popup */ "uni_modules/uni-popup/components/uni-popup/uni-popup").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-popup/components/uni-popup/uni-popup.vue */ 458))
    },
    uniRate: function() {
      return __webpack_require__.e(/*! import() | uni_modules/uni-rate/components/uni-rate/uni-rate */ "uni_modules/uni-rate/components/uni-rate/uni-rate").then(__webpack_require__.bind(null, /*! @/uni_modules/uni-rate/components/uni-rate/uni-rate.vue */ 465))
    },
    vkDataGoodsSkuPopup: function() {
      return __webpack_require__.e(/*! import() | uni_modules/vk-data-goods-sku-popup/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup */ "uni_modules/vk-data-goods-sku-popup/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup").then(__webpack_require__.bind(null, /*! @/uni_modules/vk-data-goods-sku-popup/components/vk-data-goods-sku-popup/vk-data-goods-sku-popup.vue */ 472))
    }
  }
} catch (e) {
  if (
...
__webpack_require__(/*! ../../api/detail.js */ 260),fetchDetailData = _require.fetchDetailData,fetchAddCart = _require.fetchAddCart,fetchGetCart = _require.fetchGetCart,fetchJionCollect = _require.fetchJionCollect,fetchCancelCollect = _require.fetchCancelCollect;
var that;var _default =
{
  ...
  methods: {
    ...
    // 立即购买
    buyNow: function buyNow(selectShop) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var createOrderData;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:
                console.log("监听 - 立即购买");
                ...
                uni.navigateTo({
                  url: '../confirmorder/confirmorder?createOrderData=' + encodeURIComponent(createOrderData) });case 5:case "end":return _context3.stop();}}}, _callee3);}))();
    ...
    // 收藏
    collect: function collect() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var _yield$fetchJionColle, code, _yield$fetchCancelCol, _code;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:if (!
                _this3.switch) {_context4.next = 8;break;}_context4.next = 3;return (


                  fetchJionCollect(_this3.token, _this3.id));case 3:_yield$fetchJionColle = _context4.sent;code = _yield$fetchJionColle.code;
                if (code === 1000) {
                ...
                }_context4.next = 16;break;case 8:

                _this3.isCollect = false;
                uni.setStorageSync('isCollect', false);
                _this3.switch = true;_context4.next = 13;return (


                  fetchCancelCollect(_this3.token, _this3.id));case 13:_yield$fetchCancelCol = _context4.sent;_code = _yield$fetchCancelCol.code;
                if (_code === 1000) {
                  uni.showToast({
                    title: "取消收藏成功" });
  ...
  // 监听 - 页面每次【加载时】执行(如：前进)
  onLoad: function onLoad(options) {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee5() {var userInfo, _yield$fetchDetailDat2, result, _result$goods$2, brokerageType, brokeragePrice, userLevel;return _regenerator.default.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:
              ...
              userInfo = uni.getStorageSync("userInfo");_context5.next = 9;return (
                fetchDetailData(_this4.id));case 9:_yield$fetchDetailDat2 = _context5.sent;result = _yield$fetchDetailDat2.result;_result$goods$2 =
